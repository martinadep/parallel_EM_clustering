#!/bin/bash
#PBS -N scaling_Ptest_D8
#PBS -l select=4:ncpus=16:mem=4gb
#PBS -l walltime=06:00:00
#PBS -q short_HPC4DS
#PBS -o scaling_Ptest_D8_out.txt
#PBS -e scaling_Ptest_D8_err.txt
...
# Configuration parameters: K=5, D=8
K_CLUSTERS=5
...
echo "=========================================="
echo "STARTING SCALING TEST: Ptest_D8 (N=50000, K=5, D=8)"
...
run_test() {
    ...
    TMP_LOG="run_${CORES}_Ptest_D8.log"
