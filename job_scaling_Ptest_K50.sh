#!/bin/bash
#PBS -N scaling_Ptest_K50
#PBS -l select=4:ncpus=16:mem=4gb
#PBS -l walltime=06:00:00
#PBS -q short_HPC4DS
#PBS -o scaling_Ptest_K50_out.txt
#PBS -e scaling_Ptest_K50_err.txt
...
DATASET="$PROJECT_ROOT/datasets/test/gmm_P50000_K50_D6.csv"
RESULT_CSV="$PROJECT_ROOT/results/scaling_Ptest_K50.csv"

# Configuration parameters: K=50
K_CLUSTERS=50
...
echo "=========================================="
echo "STARTING SCALING TEST: Ptest_K50 (N=50000, K=50, D=6)"
...
run_test() {
    ...
    TMP_LOG="run_${CORES}_Ptest_K50.log"
