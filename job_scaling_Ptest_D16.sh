#!/bin/bash
#PBS -N scaling_Ptest_D16
#PBS -l select=4:ncpus=16:mem=4gb
#PBS -l walltime=06:00:00
#PBS -q short_HPC4DS
#PBS -o scaling_Ptest_D16_out.txt
#PBS -e scaling_Ptest_D16_err.txt
...
DATASET="$PROJECT_ROOT/datasets/test/gmm_P50000_K5_D16.csv"
RESULT_CSV="$PROJECT_ROOT/results/scaling_Ptest_D16.csv"
...
echo "=========================================="
echo "STARTING SCALING TEST: Ptest_D16 (N=50000, K=5, D=16)"
...
run_test() {
    ...
    TMP_LOG="run_${CORES}_Ptest_D16.log"
