...
DATASET="$PROJECT_ROOT/datasets/gmm_P200000_K5_D6.csv"
RESULT_CSV="$PROJECT_ROOT/results/results_200k_6D.csv"
...
echo "=========================================="
echo "STARTING SCALING TEST: 200k POINTS, 6D"
