...
DATASET="$PROJECT_ROOT/datasets/N250000_K5_D4.csv"
RESULT_CSV="$PROJECT_ROOT/results/scaling_N250000_D4.csv"
...
echo "=========================================="
echo "STARTING SCALING TEST: N=250000, D=4"
