#!/bin/bash
#PBS -N scaling_Ptest_K5
#PBS -l select=4:ncpus=16:mem=4gb
#PBS -l walltime=06:00:00
#PBS -q short_HPC4DS
#PBS -o scaling_Ptest_K5_out.txt
#PBS -e scaling_Ptest_K5_err.txt
...
RESULT_CSV="$PROJECT_ROOT/results/scaling_Ptest_K5.csv"

# Configuration parameters: K=5
K_CLUSTERS=5
...
echo "=========================================="
echo "STARTING SCALING TEST: Ptest_K5 (N=50000, K=5, D=6)"
...
run_test() {
    ...
    TMP_LOG="run_${CORES}_Ptest_K5.log"
...
## filepath: /Users/jago/Documents/Università/4 anno/HPC for Data Science/parallel_EM_clustering/job_scaling_Ptest_K5.sh
#!/bin/bash
#PBS -N scaling_Ptest_K5
#PBS -l select=4:ncpus=16:mem=4gb
#PBS -l walltime=06:00:00
