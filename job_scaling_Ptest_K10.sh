#!/bin/bash
#PBS -N scaling_Ptest_K10
#PBS -l select=4:ncpus=16:mem=4gb
#PBS -l walltime=06:00:00
#PBS -q short_HPC4DS
#PBS -o scaling_Ptest_K10_out.txt
#PBS -e scaling_Ptest_K10_err.txt
...
echo "=========================================="
echo "STARTING SCALING TEST: Ptest_K10 (N=50000, K=10, D=6)"
...
run_test() {
    ...
    TMP_LOG="run_${CORES}_Ptest_K10.log"
