...
#PBS -q short_HPC4DS
#PBS -o scaling_N4000_out.txt
#PBS -e scaling_N4000_err.txt
...
DATASET="$PROJECT_ROOT/datasets/N4000_K4_D8.csv"
RESULT_CSV="$PROJECT_ROOT/results/scaling_N4000_D8.csv"
...
echo "=========================================="
echo "STARTING SCALING TEST: N=4000, D=8"
