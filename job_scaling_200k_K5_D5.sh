#!/bin/bash
#PBS -N scaling_200k_K5_D5
#PBS -l select=4:ncpus=16:mem=4gb
#PBS -l walltime=06:00:00
#PBS -q short_HPC4DS
#PBS -o scaling_200k_K5_D5_out.txt
#PBS -e scaling_200k_K5_D5_err.txt
...
DATASET="$PROJECT_ROOT/datasets/test/gmm_P200000_K5_D5.csv"
RESULT_CSV="$PROJECT_ROOT/results/scaling_Ptest_200k_K5_D5.csv"
...
echo "=========================================="
echo "STARTING SCALING TEST: N=200000, K=5, D=5"
...
run_test() {
    ...
    TMP_LOG="run_${CORES}_200k_K5_D5.log"
    
    # Run MPI with safety flags (disable OpenIB, force TCP)
