#!/bin/bash
#PBS -N scaling_Ptest_300k
#PBS -l select=4:ncpus=16:mem=4gb
#PBS -l walltime=06:00:00
#PBS -q short_HPC4DS
#PBS -o scaling_Ptest_300k_out.txt
#PBS -e scaling_Ptest_300k_err.txt
...
DATASET="$PROJECT_ROOT/datasets/test/gmm_P300000_K5_D6.csv"
RESULT_CSV="$PROJECT_ROOT/results/scaling_Ptest_300k.csv"
...
echo "=========================================="
echo "STARTING SCALING TEST: Ptest (N=300000, D=6)"
