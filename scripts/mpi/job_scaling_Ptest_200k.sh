...
run_test() {
   ...
   # added flags to avoid infiniband issues and network segfaults
    # --mca btl ^openib        : disable openib (cause of warnings)
    # --mca btl_vader,self,tcp : use shared memory (vader) and TCP for network
